...
15.times do
  ...
  thankscard.likes.create!(user_id: rand(2..3))
end
...
15.times do
  ...
  thankscard.likes.create!(user_id: [1, 3].sample)
end
...
15.times do
  ...
  thankscard.users_receiver.create!(user_id: [1, 2].sample)
  thankscard.likes.create!(user_id: [1, 2].sample)
end

50.times do
  content = Faker::Lorem.sentence(word_count: 5)
  users2.comments.create!(comment_content: content, thanks_card_id: rand(1..45))
end

50.times do
  content = Faker::Lorem.sentence(word_count: 5)
  users.comments.create!(comment_content: content, thanks_card_id: rand(1..45))
end
